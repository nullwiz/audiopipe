...
def combine_diarization_with_transcription(diarization_segments, transcription_chunks):
    ...
    for chunk in transcription_chunks:
        ...
        for segment in diarization_segments:
            if (segment["start"] <= chunk_end and 
...
def process_audio_with_diarization(audio_path, transcription_output_path=None, num_speakers=None, min_speakers=None, max_speakers=None):
    """
    ...
    diarization_segments = diarize_audio(audio_path, num_speakers, min_speakers, max_speakers)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--transcription", "-t", help="Optional: Path to transcription JSON file", default=None)
    parser.add_argument("--num-speakers", "-n", type=int, help="Exact number of speakers", default=None)
    parser.add_argument("--min-speakers", type=int, help="Minimum number of speakers", default=None)
    parser.add_argument("--max-speakers", type=int, help="Maximum number of speakers", default=None)
